...
export const PROTECTED_ROUTES = {
  ...
  branchSummary: '/branch/:branchId/:tenantId',
...
export const SIDE_MENU_MAPPER = {
  ...
  BRANCH_SUMMARY: PROTECTED_ROUTES.branchSummary,
...
export const HOME_PAGE_BY_ROLE = {
  ...
  [APPCONSTANTS.ROLES.AREA_MANAGER]: PROTECTED_ROUTES.regionDashboard,
  [APPCONSTANTS.ROLES.DIVISIONAL_MANAGER]: PROTECTED_ROUTES.regionDashboard,
  [APPCONSTANTS.ROLES.HO]: PROTECTED_ROUTES.regionDashboard,
};
