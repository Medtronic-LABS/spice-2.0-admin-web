const APPCONSTANTS = {
  ...
  SHASTIYA_SHEBIKA_FETCH_FAIL: 'Unable to load Shastiya Shebika users data. Please try after sometime.',
  SHASTIYA_SHEBIKA_CREATE_FAIL: 'Unable to create Shastiya Shebika user. Please try after sometime.',
