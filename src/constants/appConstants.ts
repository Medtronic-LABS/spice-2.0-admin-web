const APPCONSTANTS = {
  ...
  ROLES: {
    ...
    DIVISIONAL_MANAGER: 'DIVISIONAL_MANAGER',
    HO: 'HO'
  },
  ALL_ROLES: {
    SUPER_USER: 'SUPER_USER',
  ...
  HEALTH_FACILITY_DEACTIVATE_CONFIRMATION:
    'This module_name has users linked to it. Are you sure you want to deactivate it?',
  HEALTH_FACILITY_DEACTIVATE_SUCCESS: 'Module_name deactivated successfully',
  ...
  HEALTH_FACILITY_USER_DELETE_CONFIRMATION: 'Are you sure you want to delete the module_name user? If the user is a Shastiya Kormi, all associated Shasthya Shebika users will also be deleted.',
  ...
  USER_DELETE_CONFIRMATION: 'Are you sure you want to delete this user? If the user is a Shastiya Kormi, all associated Shasthya Shebika users will also be deleted.',
  ...
  SHASTIYA_SHEBIKA_FETCH_FAIL: 'Unable to load Shasthya Shebika users data. Please try after sometime.',
  SHASTIYA_SHEBIKA_CREATE_FAIL: 'Unable to create Shasthya Shebika user. Please try after sometime.',
  SHASTIYA_SHEBIKA_DELETE_SUCCESS: 'Shasthya Shebikas deleted successfully',
  ...
  USERNAME_ALREADY_EXISTS_ERR_MSG: 'Username already exists',
