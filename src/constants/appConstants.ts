const APPCONSTANTS = {
  ...
  COUNTY_UPDATE_SUCCESS: 'Module_Name name updated successfully.',
  COUNTY_UPDATE_FAIL: 'Unable to update module_name summary. Please try after sometime.',
  COUNTY_DEACTIVATE_SUCCESS: 'Module_Name deactivated successfully.',
  COUNTY_DEACTIVATE_FAIL: 'Unable to deactivate the module_name. Please try after sometime.',
  COUNTY_CREATION_SUCCESS: 'Module_Name created successfully.',
  COUNTY_CREATION_FAIL: 'Unable to create module_name. Please try after sometime.',
  COUNTY_ADMIN_DELETE_CONFIRMATION: 'Are you sure want to delete module_name admin?',
  COUNTY_ADMIN_DELETE_TITLE: 'Delete Module_Name Admin',
  COUNTY_DETAIL_FETCH_ERROR: 'Unable to load module_name summary. Please try after sometime.',
  COUNTY_ADMIN_CREATE_SUCCESS: 'Module_Name admin added successfully.',
  COUNTY_ADMIN_CREATE_FAIL: 'Unable to add module_name admin. Please try after sometime',
  COUNTY_ADMIN_UPDATE_SUCCESS: 'Module_name admin updated successfully.',
  COUNTY_ADMIN_UPDATE_FAIL: 'Unable to update module_name admin. Please try after sometime',
  COUNTY_ADMIN_DELETE_SUCCESS: 'Module_name admin deleted successfully.',
  COUNTY_ADMIN_DELETE_FAIL: 'Unable to delete module_name admin. Please try after sometime.',
  COUNTY_FETCH_ERROR: 'Unable to load module_name. Please try after sometime.',
  // SUB COUNTY
  ...
  SUB_COUNTY_FETCH_ERROR: 'Unable to load module_names. Please try after sometime.',
