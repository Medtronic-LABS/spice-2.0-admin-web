...
export const allSingleRoles = ['HE', 'CHCP', 'SHASTIYA_KORMI', 'PO', 'FO', 'AREA_MANAGER', 'DIVISIONAL_MANAGER', 'HO'];
// REPORTS
...
export const PHUInchargePlusFacilityReportAdmin = ['FACILITY_REPORT_ADMIN']; // removed the PHU Incharge role
export const facilityPlusHF4PlusPHU = [hf4ReportUser, 'FACILITY_REPORT_ADMIN'];
// INSIGHTS
