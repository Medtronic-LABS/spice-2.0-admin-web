...
describe('CreateAccount', () => {
  ...
  it('should render AccountForm and UserForm inside FormContainer components', () => {
    ...
    const accountFormContainer = componentWrapper.find('FormContainer[label="Account Details"]');

    const userFormContainer = componentWrapper.find('FormContainer[label="Account Admin"]');
