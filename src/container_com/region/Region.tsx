...
import { downloadFileRequest, regionDetailsRequest, uploadFileRequest } from '../../store/region_com/actions';
import {
  getIsUploadingSelector,
  getLoadingSelector,
  getRegionDetailSelector,
  getRegionDetailsSelector
} from '../../store/region_com/selectors';
import toastCenter, { getErrorToastArgs } from '../../utils/toastCenter';
import ModalForm from '../../components/modal/ModalForm';
import arrayMutators from 'final-form-arrays';
import { fileDownload } from '../../utils/commonUtils';

const RegionCom = (): React.ReactElement => {
  ...
  const onDownloadClick = () => {
    dispatch(
      downloadFileRequest({
        countryId: Number(region?.id),
        successCb: (data) => {
          const filename = region.name;
  ...
  }, [dispatch, listParams.page, listParams.rowsPerPage, listParams.searchTerm, region?.id]);
