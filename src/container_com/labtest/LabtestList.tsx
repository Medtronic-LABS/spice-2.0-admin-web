...
import { labtestLoadingSelector, labtestsSelector, labtestCountSelector } from '../../store/labTest_com/selectors';
import { ILabTest } from '../../store/labTest_com/types';
 ...
 */
const LabTestListCom = (props: IMatchProps): React.ReactElement => {
  ...
  const routeToLabtestCustomizationPage = (data: any) => {
    props.history.push(
      PROTECTED_ROUTES.customizeLabTestCom
