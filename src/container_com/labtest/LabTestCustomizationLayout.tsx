...
import { formMetaSelector } from '../../store/workflow_com/selectors';
import APPCONSTANTS from '../../constants/appConstantsCom';
import { PROTECTED_ROUTES } from '../../constants/route';
import Loader from '../../components/loader/Loader';
import AccordianView from '../../components_com/formBuilder/components/accordian/AccordianView';
import { clearFormJSON } from '../../store/workflow_com/actions';
import toastCenter, { getErrorToastArgs } from '../../utils/toastCenter';
import ReorderView from '../../components_com/formBuilder/components/reorder/ReorderView';
import { getConfigByViewType } from '../../components_com/formBuilder/utils/FieldUtils';
import useFormCustomization from '../../components_com/formBuilder/hooks/useFormCustomization';
import {
  fetchLabTestCustomizationRequest,
  fetchUnitListRequest,
  labtestCustomization
} from '../../store/labTest_com/actions';
import { labTestJSONLoadingSelector } from '../../store/labTest_com/selectors';
...
const LabTestCustomizationLayoutCom = () => {
  ...
  const onCancel = () => {
    history.push(PROTECTED_ROUTES.labtestListCom.replace(':tenantId', tenantId).replace(':regionId', regionId));
  };
...
export default LabTestCustomizationLayoutCom;
