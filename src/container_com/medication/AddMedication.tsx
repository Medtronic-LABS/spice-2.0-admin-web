...
import { createMedicationRequest, validateMedication } from '../../store/medication_com/actions';
...
const AddMedicationCom = (props: Props) => {
  ...
  const goBackToMedication = () => {
    const url = PROTECTED_ROUTES.medicationByRegionCom;
...
export default AddMedicationCom;
