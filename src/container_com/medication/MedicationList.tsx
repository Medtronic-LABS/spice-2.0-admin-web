...
} from '../../store/medication_com/selectors';
import { deleteMedication, fetchMedicationListReq, updateMedication } from '../../store/medication_com/actions';
 ...
 */
const MedicationListCom = (): React.ReactElement => {
...
export default MedicationListCom;
