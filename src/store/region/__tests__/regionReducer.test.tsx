...
describe('regionReducer', () => {
  it('should handle UPLOAD_FILE_REQUEST', () => {
    ...
    const action: any = {
      type: REGIONTYPES.UPLOAD_FILE_REQUEST
    };
    const expectedState = {
      uploading: true
    };
  ...
  it('should handle UPLOAD_FILE_SUCCESS', () => {
    ...
    const action: any = {
      type: REGIONTYPES.UPLOAD_FILE_SUCCESS,
      payload: {} as any
    };
    const expectedState = {
      uploading: false,
  ...
  it('should handle UPLOAD_FILE_FAILURE', () => {
    ...
    const action: any = {
      type: REGIONTYPES.UPLOAD_FILE_FAILURE,
  ...
  it('should handle DOWNLOAD_FILE_REQUEST', () => {
    ...
    const action: any = {
      type: REGIONTYPES.DOWNLOAD_FILE_REQUEST
    };
    const expectedState = {
      downloading: true
    };
  ...
  it('should handle DOWNLOAD_FILE_SUCCESS', () => {
    ...
    const action: any = {
      type: REGIONTYPES.DOWNLOAD_FILE_SUCCESS
    };
    const expectedState = {
      downloading: false,
      error: null
  ...
  it('should handle DOWNLOAD_FILE_FAILURE', () => {
    ...
    const action: any = {
      type: REGIONTYPES.DOWNLOAD_FILE_FAILURE,
  ...
  it('should handle REGION_DETAILS_REQUEST', () => {
    ...
    const action: any = {
      type: REGIONTYPES.REGION_DETAILS_REQUEST
    };
    const expectedState = {
      loading: true
    };
  ...
  it('should handle REGION_DETAILS_SUCCESS', () => {
    ...
    const action: any = {
      type: REGIONTYPES.REGION_DETAILS_SUCCESS,
  ...
  it('should handle REGION_DETAILS_FAILURE', () => {
    ...
    const action: any = {
      type: REGIONTYPES.REGION_DETAILS_FAILURE,
