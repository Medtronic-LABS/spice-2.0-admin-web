...
import * as workflowService from '../../services_com/workflowAPI';
import { ICustomizeFormRequest, IFetchCustomizationFormRequest, IDeactivateConsentRequest } from './types';
...
export default workflowSagaCom;
