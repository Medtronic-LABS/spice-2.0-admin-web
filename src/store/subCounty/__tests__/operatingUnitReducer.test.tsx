...
describe('operatingUnitReducer', () => {
  ...
  it('should handle FETCH_OPERATING_UNIT_DASHBOARD_LIST_REQUEST', () => {
    ...
    expect(operatingUnitReducer(mainInitialState, action)).toEqual(expectedState);
  });
  ...
  it('should handle FETCH_OPERATING_UNIT_DETAIL_FAILURE', () => {
    ...
    const expectedState = {
      ...
      loading: false,
      error: action.error,
      operatingUnitDetail: mainInitialState.operatingUnitDetail
    };
    expect(operatingUnitReducer(mainInitialState, action)).toEqual(expectedState);
  });
  ...
  it('should clear operating unit list', () => {
    ...
    const newState = operatingUnitReducer(mainInitialState, action);
