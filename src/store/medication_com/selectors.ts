...
const getLoading = (state: AppState) => state.medicationCom.loading;
const getMedicationList = (state: AppState) => state.medicationCom.list;
const getMedicationListCount = (state: AppState) => state.medicationCom.total;
const getMedicationClassifications = (state: AppState) => state.medicationCom.classifications;
const getMedicationBrands = (state: AppState) => state.medicationCom.brands;
const getMedicationDosageForm = (state: AppState) => state.medicationCom.dosageForms;
const getClassificationsLoading = (state: AppState) => state.medicationCom.classificationsLoading;
const getBrandsLoading = (state: AppState) => state.medicationCom.brandsLoading;
const getDosageFormsLoading = (state: AppState) => state.medicationCom.dosageFormsLoading;
