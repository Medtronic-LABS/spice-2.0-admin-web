import * as HEALTH_FACILITY_ACTION_TYPES from './actionTypes';
...
const initialState: IHealthFacilityState = {
  ...
  insightHealthFacilityList: [] as IHealthFacility[],
  insightHFLoading: false,
...
const healthFacilityReducerCom = (
  ...
  switch (action.type) {
    ...
    case HEALTH_FACILITY_ACTION_TYPES.FETCH_INSIGHT_HEALTH_FACILITY_LIST_SUCCESS:
      return {
        ...state,
        insightHFLoading: false,
        insightHealthFacilityList: action.payload || []
      };
    ...
    case HEALTH_FACILITY_ACTION_TYPES.FETCH_INSIGHT_HEALTH_FACILITY_LIST_REQUEST:
      return {
        ...state,
        insightHFLoading: true
      };
    case HEALTH_FACILITY_ACTION_TYPES.FETCH_HEALTH_FACILITY_LIST_REQUEST_COM:
    ...
    case HEALTH_FACILITY_ACTION_TYPES.FETCH_INSIGHT_HEALTH_FACILITY_LIST_FAILURE:
...
export default healthFacilityReducerCom;
