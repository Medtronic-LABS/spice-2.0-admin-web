...
export interface IHealthFacilityState {
  ...
  insightHealthFacilityList: IHealthFacility[];
  insightHFLoading: boolean;
  hfTotal: number;
...
export interface IFetchHFListRequest {
  type: typeof ACTION_TYPES.FETCH_HEALTH_FACILITY_LIST_REQUEST_COM;
  countryId: number;
  skip: number;
  limit: number | null;
  searchTerm?: string;
...
export interface IFetchInsightHFListRequest {
  type: typeof ACTION_TYPES.FETCH_INSIGHT_HEALTH_FACILITY_LIST_REQUEST;
  countryId: number;
  successCb?: (data: IHealthFacility[]) => void;
  failureCb?: (error: Error) => void;
}

export interface IFetchInsightHFListSuccess {
  type: typeof ACTION_TYPES.FETCH_INSIGHT_HEALTH_FACILITY_LIST_SUCCESS;
  payload: IHealthFacility[];
}

export interface IFetchInsightHFListFailure {
  type: typeof ACTION_TYPES.FETCH_INSIGHT_HEALTH_FACILITY_LIST_FAILURE;
  error: Error;
}
