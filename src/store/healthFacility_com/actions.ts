...
import {
  ...
  IClearHFFormData,
  IFetchInsightHFListRequest,
  IFetchInsightHFListSuccess,
  IFetchInsightHFListFailure
} from './types';
...
export const fetchHFListRequest = ({
  ...
  return {
    type: HF_TYPES.FETCH_HEALTH_FACILITY_LIST_REQUEST_COM,
    skip,
    limit,
    countryId,
    searchTerm,
...
export const fetchInsightHFListRequest = ({
  countryId,
  successCb,
  failureCb
}: Omit<IFetchInsightHFListRequest, 'type'>): IFetchInsightHFListRequest => ({
  type: HF_TYPES.FETCH_INSIGHT_HEALTH_FACILITY_LIST_REQUEST,
  countryId,
  successCb,
  failureCb
});

export const fetchInsightHFListSuccess = (payload: IHealthFacility[]): IFetchInsightHFListSuccess => ({
  type: HF_TYPES.FETCH_INSIGHT_HEALTH_FACILITY_LIST_SUCCESS,
  payload
});

export const fetchInsightHFListFailure = (error: Error): IFetchInsightHFListFailure => ({
  type: HF_TYPES.FETCH_INSIGHT_HEALTH_FACILITY_LIST_FAILURE,
  error
});
...
export const clearAllHFFormData = (): IClearHFFormData => ({
