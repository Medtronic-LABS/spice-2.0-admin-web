...
export const FETCH_SL_USER_ROLES_REQUEST = 'FETCH_SL_USER_ROLES_REQUEST';
export const FETCH_SL_USER_ROLES_SUCCESS = 'FETCH_SL_USER_ROLES_SUCCESS';
export const FETCH_SL_USER_ROLES_FAILURE = 'FETCH_SL_USER_ROLES_FAILURE';
