...
describe('Upload File for Region Data mapping', () => {
  it('should upload file successfully', async () => {
    ...
    await runSaga(
      ...
      uploadFileSaga,
      { file: {} as any, type: ACTION_TYPES.UPLOAD_FILE_REQUEST_COM }
    ).toPromise();
...
describe('Region Data Download file', () => {
  it('should download file successfully', async () => {
    ...
    await runSaga(
      ...
      downloadFileSaga,
      { countryId: 1, type: ACTION_TYPES.DOWNLOAD_FILE_REQUEST_COM }
    ).toPromise();
...
describe('Fetch Region Details', () => {
  it('should fetch the region details successfully', async () => {
    ...
    await runSaga(
      ...
      regionDetailsSaga,
      { ...regionDetailsRequestMockData, type: ACTION_TYPES.REGION_DETAILS_REQUEST_COM }
    ).toPromise();
