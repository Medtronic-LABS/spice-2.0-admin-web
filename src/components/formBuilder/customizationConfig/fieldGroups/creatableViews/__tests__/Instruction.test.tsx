...
describe('InstructionConfig', () => {
  ...
  it('should have a valid customizableFieldMeta object', () => {
    const { instructions, fieldName, title, visibility } = INSTRUCTION_CONFIG.customizableFieldMeta;
  ...
  it('should have a valid with label getJSON function', () => {
    const json = {
      id: '123456',
      viewType: 'Instruction',
      title: 'Instructions',
      fieldName: { label: 'instructionField' },
      family: 'instructionFamily',
      isSummary: true,
      isMandatory: true,
      isEnabled: false,
